...
// All achievements data - IDs match the API
const achievementsData: Achievement[] = [
  ...
  // Special Achievements
  {
    id: "explorer",
    title: "المستكشف",
    description: "زِر 5 وجهات مختلفة",
      ...
      try {
        ...
        if (data.success) {
          ...
          setAchievements(prev => prev.map(achievement => {
            ...
            if (!apiAchievement) {
              // Remove achievements not returned by API
              return null as unknown as Achievement;
            }
            return {
              ...achievement,
              ...
              // Don't set fake dates - unlockedAt should come from API when implemented
